        ...
        if args.viz:
            with torch.no_grad():
                ...
                if args.gyre_type == 'single':
                    ...
                    pred_traj_1         = odeint(func, true_init_cond_traj_1.unsqueeze(dim =1) , true_time_traj_1 , method=args.method, options=dict(step_size=0.02))
                    ...
                    visualize_single_gyre_streamplot(itr, true_time_traj_1, true_traj_1, pred_traj_1.squeeze(dim=1), func,
                ...
                # 2. For Double Gyre
                    ...
                    pred_traj_1         = odeint(func, true_init_cond_traj_1.unsqueeze(dim =1) , true_time_traj_1 , method=args.method, options=dict(step_size=0.02))
                    pred_traj_2         = odeint(func, true_init_cond_traj_2.unsqueeze(dim =1) , true_time_traj_2 , method=args.method, options=dict(step_size=0.02))
                    ...
                    visualize_double_gyre_streamplot(itr, true_time_traj_1, true_time_traj_2, true_traj_1, true_traj_2,
                                                     pred_traj_1.squeeze(dim=1) , pred_traj_2.squeeze(dim=1), func,
