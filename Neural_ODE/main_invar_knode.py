...
if args.viz:
    if args.gyre_type == 'double':
        ...
        fig_q, ax_true_vecfield, ax_pred_vecfield , ax_err_vecfield, cbar_ax_1, cbar_ax_2, cbar_ax_3 = create_fig(args.exp, 'single','KNODE',cbar=True)
    if args.gyre_type == 'single':
...
# saving model
torch.save(hybrid_model.state_dict(), 'Models/' + plot_path_t + plot_path + '/KNODE/model.pth')
